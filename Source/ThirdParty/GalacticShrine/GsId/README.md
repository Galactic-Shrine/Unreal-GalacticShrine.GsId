...
Bibliothèque C++20 fournissant `GalacticShrine::GsId`, un identifiant de 256 bits conservé sous forme de 32 octets bruts. La copie intégrée à la distribution GitHub de GsId 1.0.1 est publiée sous licence MIT.
